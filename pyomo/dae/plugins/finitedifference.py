...
class Finite_Difference_Transformation(Transformation):
    ...
    def apply(self, instance, **kwds):
        ...
        """
        # The discretization expressions generated by this transformation
        # are specific to a model instance. Therefore, if the user applies
        # the transformation to each differentialset individually, we want
        # to continue modifying the same instance and not a new copy each time
