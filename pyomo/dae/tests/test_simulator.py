...
class TestSimulator(unittest.TestCase):
    ...
    # Checking multi-dimensional multi-index case
    def test_sim_initialization_multi_index2(self):
        ...
        self.assertTrue(isinstance(mysim._rhsdict[_GetItemIndexer(m.dw3[0,t,1,1])],
                                   EXPR._SumExpression))
        self.assertTrue(isinstance(mysim._rhsdict[_GetItemIndexer(m.dw3[1,t,2,2])],
                                   EXPR._SumExpression))
