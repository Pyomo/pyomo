...
class TestMindtPy(unittest.TestCase):
    ...
    #         model = SimpleMINLP()
    #         print('Solving problem with Outer Approximation')
    ...
    #     with SolverFactory('mindtpy') as opt:
    #         model = SimpleMINLP()
    #         print('Solving problem with Partial Surrogate Cuts')
    ...
    def test_GBD(self):
        ...
        with SolverFactory('mindtpy') as opt:
            model = SimpleMINLP()
            print('Solving problem with Generalized Benders Decomposition')
