...
class DummyWriter(AbstractProblemWriter):

    def __init__(self, name=None):
        AbstractProblemWriter.__init__(self,name)


class DummyReader(AbstractResultsReader):
...
class OptFactoryDebug(unittest.TestCase):
    ...
    def test_solver_factory(self):
        ...
        """
        SolverFactory.register('stest3')(DummySolver)
    ...
    def test_writer_factory(self):
        ...
        """
        WriterFactory.register('wtest3')(DummyWriter)
    ...
    def test_reader_factory(self):
        ...
        """
        ReaderFactory.register('rtest3')(DummyReader)
        ans = ReaderFactory
