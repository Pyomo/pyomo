...
class TestPort(unittest.TestCase):
    ...
    def test_arc_lists(self):
        ...
        self.assertEqual(len(m.p1.dests(active=False)), 2)
        self.assertEqual(len(m.p1.sources(active=False)), 2)
        self.assertEqual(len(m.p1.arcs(active=False)), 4)
        self.assertEqual(len(m.p2.dests(active=False)), 0)
        self.assertEqual(len(m.p2.sources(active=False)), 1)
        self.assertEqual(len(m.p2.arcs(active=False)), 1)
        self.assertIn(m.a1, m.p1.dests(active=False))
        self.assertIn(m.a1, m.p2.sources(active=False))
        self.assertNotIn(m.a1, m.p1.sources(active=False))
        self.assertNotIn(m.a1, m.p2.dests(active=False))
