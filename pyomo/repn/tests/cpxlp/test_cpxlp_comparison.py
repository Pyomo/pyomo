...
#
#The following test generates an lp file for the test case
#and checks that it matches the current pyomo baseline lp file
#
@unittest.nottest
def lp_writer_baseline_test(self, name):
    ...
    self.assertFileEqualsBaseline(
        currdir+name+'.test.lp', currdir+name+'.pyomo.lp',
