...
model.obj = Objective(expr=10.0*Expr_if(IF_=model.v0,
                                            THEN_=model.vTrue,
                                            ELSE_=model.vFalse))

# True/False
model.c1 = Constraint(expr= Expr_if(IF_=(0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pFalse)
model.c2 = Constraint(expr= Expr_if(IF_=(1), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pTrue)

# x <= 0
model.c3 = Constraint(expr= Expr_if(IF_=(model.vN1 <= 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pTrue)
model.c4 = Constraint(expr= Expr_if(IF_=(model.v0  <= 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pTrue)
model.c5 = Constraint(expr= Expr_if(IF_=(model.vP1 <= 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pFalse)

# x < 0
model.c6 = Constraint(expr= Expr_if(IF_=(model.vN1 < 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pTrue)
model.c7 = Constraint(expr= Expr_if(IF_=(model.v0  < 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pFalse)
model.c8 = Constraint(expr= Expr_if(IF_=(model.vP1 < 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pFalse)

# x >= 0
model.c9 = Constraint(expr= Expr_if(IF_=(model.vN1*10.0 >= 0), THEN_=(model.vTrue), ELSE_=(model.vFalse))  == model.pFalse)
model.c10 = Constraint(expr= Expr_if(IF_=(model.v0*10.0  >= 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pTrue)
model.c11 = Constraint(expr= Expr_if(IF_=(model.vP1*10.0 >= 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pTrue)

# x > 0
model.c12 = Constraint(expr= Expr_if(IF_=(model.vN1*10.0 > 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pFalse)
model.c13 = Constraint(expr= Expr_if(IF_=(model.v0*10.0  > 0), THEN_=(model.vTrue), ELSE_=(model.vFalse)) == model.pFalse)
