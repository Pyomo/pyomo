...
c1.. 0.5*(1/2.0)*x1*(x2 - x3) =e= 2.0 ;
c2.. x1*(1/2.0)*(1/2.0)*(x2 - x3) =e= 2.0 ;
c3.. 0.5*x1*(x2 - x3)*(1/2.0) =e= 2.0 ;
c4.. x1*(0.5*x2*(1/2.0) - 0.5*x3*(1/2.0)) =e= 2.0 ;
c5.. x1*(x2 - x3)*0.5*(1/2.0) =e= 2.0 ;
c6.. x1*(x2 - x3) - 2.0*2.0*2.0 =e= 0.0 ;
...
c12.. x1*(x2 - x3) - 2.0*2.0*2.0 =e= 0.0 ;
