...
c3.. Expr_if( ( vN1  <=  0 ), then=( vTrue ), else=( vFalse ) ) =e= 1 ;
c4.. Expr_if( ( v0  <=  0 ), then=( vTrue ), else=( vFalse ) ) =e= 1 ;
c5.. Expr_if( ( vP1  <=  0 ), then=( vTrue ), else=( vFalse ) ) =e= -1 ;
c6.. Expr_if( ( vN1  <  0 ), then=( vTrue ), else=( vFalse ) ) =e= 1 ;
c7.. Expr_if( ( v0  <  0 ), then=( vTrue ), else=( vFalse ) ) =e= -1 ;
c8.. Expr_if( ( vP1  <  0 ), then=( vTrue ), else=( vFalse ) ) =e= -1 ;
c9.. Expr_if( ( 0  <=  10.0*vN1 ), then=( vTrue ), else=( vFalse ) ) =e= -1 ;
c10.. Expr_if( ( 0  <=  10.0*v0 ), then=( vTrue ), else=( vFalse ) ) =e= 1 ;
c11.. Expr_if( ( 0  <=  10.0*vP1 ), then=( vTrue ), else=( vFalse ) ) =e= 1 ;
c12.. Expr_if( ( 0  <  10.0*vN1 ), then=( vTrue ), else=( vFalse ) ) =e= -1 ;
c13.. Expr_if( ( 0  <  10.0*v0 ), then=( vTrue ), else=( vFalse ) ) =e= -1 ;
c14.. Expr_if( ( 0  <  10.0*vP1 ), then=( vTrue ), else=( vFalse ) ) =e= 1 ;
