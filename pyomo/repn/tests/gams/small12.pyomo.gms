...
c15.. Expr_if( ( -1.0  <=  vN2  <=  1.0 ), then=( vTrue ), else=( vFalse ) ) =e= -1.0 ;
c16.. Expr_if( ( - vP1  <=  vN1  <=  1.0 ), then=( vTrue ), else=( vFalse ) ) =e= 1.0 ;
c17.. Expr_if( ( - vP1**2  <=  v0  <=  1.0 ), then=( vTrue ), else=( vFalse ) ) =e= 1.0 ;
c18.. Expr_if( ( vN1  <=  vP1  <=  1.0 ), then=( vTrue ), else=( vFalse ) ) =e= 1.0 ;
c19.. Expr_if( ( -1.0  <=  vP2  <=  1.0 ), then=( vTrue ), else=( vFalse ) ) =e= -1.0 ;
c20.. Expr_if( ( -1.0  <  vN2  <  1.0 ), then=( vTrue ), else=( vFalse ) ) =e= -1.0 ;
c21.. Expr_if( ( -1.0  <  vN1  <  vP1 ), then=( vTrue ), else=( vFalse ) ) =e= -1.0 ;
c22.. Expr_if( ( -1.0  <  v0  <  vP1**2 ), then=( vTrue ), else=( vFalse ) ) =e= 1.0 ;
c23.. Expr_if( ( -1.0  <  vP1  <  vP1 ), then=( vTrue ), else=( vFalse ) ) =e= -1.0 ;
c24.. Expr_if( ( -1.0  <  vP2  <  1.0 ), then=( vTrue ), else=( vFalse ) ) =e= -1.0 ;
