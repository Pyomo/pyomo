...
class SubModel(SimpleBlock):
    ...
    @deprecated("Use of the pyomo.bilevel package is deprecated. Development of bilevel "
                "optimization capabilities has been shifted to the Pyomo Adversarial "
                "Optimization (PAO) library. Please contact William Hart for further "
                "details (wehart@sandia.gov).")
