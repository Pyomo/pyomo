...
def bilevel_exec(args=None):
    return coopr.pyomo.scripting.util.run_command(command=run_bilevel, parser=bilevel_parser, args=args, name='bilevel')

#
# Add a subparser for the coopr command
#
bilevel_parser = create_parser(
    coopr_parser.add_subparser('bilevel',
        func=bilevel_exec,
        help='Analyze a bilevel model',
        description='This coopr subcommand is used to analyze bilevel models.'
        ))
