...
def bilevel_exec(args=None):
    return pyomo.core.scripting.util.run_command(command=run_bilevel, parser=bilevel_parser, args=args, name='bilevel')

#
# Add a subparser for the pyomo command
#
bilevel_parser = create_parser(
    pyomo_parser.add_subparser('bilevel',
        func=bilevel_exec,
        help='Analyze a bilevel model',
        description='This pyomo subcommand is used to analyze bilevel models.'
        ))
