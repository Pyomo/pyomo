...
class BooleanValue(object):
    ...
    # [QC 2020-06-17]: The code below serves a more intelligible error message when a
    # BooleanValue is used improperly in a numeric context. Following discussion with
    # John Siirola, we decided to omit it until it becomes evident that our users need
    # the special error messages.
    #
    # def __float__(self):
    #     raise TypeError(
