...
class TestScaleModelTransformation(unittest.TestCase):
    ...
    def test_linear_scaling(self):
        ...
        self.assertAlmostEqual(pe.value(unscaled_model.x[2]), pe.value(scaled_model.x[2])/x_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.x[3]), pe.value(scaled_model.x[3])/x_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.z), pe.value(scaled_model.z)/z_scale, 4)
        # check var lb
        self.assertAlmostEqual(pe.value(unscaled_model.x[1].lb), pe.value(scaled_model.x[1].lb)/x_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.x[2].lb), pe.value(scaled_model.x[2].lb)/x_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.x[3].lb), pe.value(scaled_model.x[3].lb)/x_scale, 4)
        # note: z_scale is negative, therefore, the inequality directions swap
        self.assertAlmostEqual(pe.value(unscaled_model.z.lb), pe.value(scaled_model.z.ub)/z_scale, 4)
        # check var ub
        self.assertAlmostEqual(pe.value(unscaled_model.x[1].ub), pe.value(scaled_model.x[1].ub)/x_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.x[2].ub), pe.value(scaled_model.x[2].ub)/x_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.x[3].ub), pe.value(scaled_model.x[3].ub)/x_scale, 4)
        # note: z_scale is negative, therefore, the inequality directions swap
        self.assertAlmostEqual(pe.value(unscaled_model.z.ub), pe.value(scaled_model.z.lb)/z_scale, 4)
        # check var multipliers (rc)
        self.assertAlmostEqual(pe.value(unscaled_model.rc[unscaled_model.x[1]]), pe.value(scaled_model.rc[scaled_model.x[1]])*x_scale/obj_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.rc[unscaled_model.x[2]]), pe.value(scaled_model.rc[scaled_model.x[2]])*x_scale/obj_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.rc[unscaled_model.x[3]]), pe.value(scaled_model.rc[scaled_model.x[3]])*x_scale/obj_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.rc[unscaled_model.z]), pe.value(scaled_model.rc[scaled_model.z])*z_scale/obj_scale, 4)
        # check constraint multipliers
        self.assertAlmostEqual(pe.value(unscaled_model.dual[unscaled_model.con[1]]),pe.value(scaled_model.dual[scaled_model.con[1]])*con_scale1/obj_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.dual[unscaled_model.con[2]]),pe.value(scaled_model.dual[scaled_model.con[2]])*con_scale2/obj_scale, 4)
        self.assertAlmostEqual(pe.value(unscaled_model.dual[unscaled_model.con[3]]),pe.value(scaled_model.dual[scaled_model.con[3]])*con_scale3/obj_scale, 4)
...
if __name__ == "__main__":
    TestScaleModelTransformation().test_linear_scaling()
#    unittest.main()
