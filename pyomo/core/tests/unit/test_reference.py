...
""",
    ...
    def test_reference_indexedcomponent_pprint(self):
        ...
        self.assertEqual(
            ...
            """r : Size=2, Index={1, 2}, ReferenceTo=x
    Key : Object
      1 : <class 'pyomo.core.base.var.GeneralVarData'>
      2 : <class 'pyomo.core.base.var.GeneralVarData'>
""",
        )
...
1 IndexedComponent Declarations
    ref : Size=2, Index=NonNegativeIntegers, ReferenceTo=v
        Key : Object
          3 : <class 'pyomo.core.base.var.GeneralVarData'>
          5 : <class 'pyomo.core.base.var.GeneralVarData'>
