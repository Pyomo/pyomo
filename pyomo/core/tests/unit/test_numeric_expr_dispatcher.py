    ...
    def test_add_asbinary(self):
        tests = [
            ...
            (
                self.asbinary,
                self.one,
                LinearExpression([self.mon_bin, 1]),
            ),
            # 4:
            (
                self.asbinary,
                self.native,
                LinearExpression([self.mon_bin, 5]),
            ),
            (
                self.asbinary,
                self.npv,
            ...
            (
                self.asbinary,
                self.param,
                LinearExpression([self.mon_bin, 6]),
            ),
            (
                self.asbinary,
                self.param_mut,
                LinearExpression(
                    [self.mon_bin, self.param_mut]
                ),
            ),
            # 8:
            (
    ...
    def test_add_one(self):
        tests = [
            ...
            (
                self.one,
                self.asbinary,
                LinearExpression([1, self.mon_bin]),
            ),
            ...
            (
                self.one,
                self.var,
                LinearExpression([1, self.mon_var]),
            ),
    ...
    def test_add_native(self):
        tests = [
            ...
            (
                self.native,
                self.asbinary,
                LinearExpression([5, self.mon_bin]),
            ),
            ...
            (
                self.native,
                self.var,
                LinearExpression([5, self.mon_var]),
            ),
    ...
    def test_add_npv(self):
        tests = [
            ...
            (
                self.npv,
                self.asbinary,
                LinearExpression([self.npv, self.mon_bin]),
            ),
            ...
            (
                self.npv,
                self.var,
                LinearExpression([self.npv, self.mon_var]),
            ),
    ...
    def test_add_param(self):
        tests = [
            ...
            (
                self.param,
                self.asbinary,
                LinearExpression([6, self.mon_bin]),
            ),
            ...
            (
                self.param,
                self.var,
                LinearExpression([6, self.mon_var]),
            ),
    ...
    def test_add_var(self):
        tests = [
            ...
            (
                self.var,
                self.one,
                LinearExpression([self.mon_var, 1]),
            ),
            # 4:
            (
                self.var,
                self.native,
                LinearExpression([self.mon_var, 5]),
            ),
            (
                self.var,
                self.npv,
                LinearExpression([self.mon_var, self.npv]),
            ),
            (
                self.var,
                self.param,
                LinearExpression([self.mon_var, 6]),
            ),
            (
                self.var,
                self.param_mut,
                LinearExpression(
                    [self.mon_var, self.param_mut]
                ),
            ),
            # 8:
            (
            ...
            (
                ...
                self.mon_param,
                LinearExpression(
                    [self.mon_var, self.mon_param]
                ),
            ),
            (
                self.var,
                self.mon_npv,
                LinearExpression([self.mon_var, self.mon_npv]),
            ),
            # 12:
            (
                self.var,
            ...
            (
                ...
                self.mutable_l1,
                LinearExpression(
                    [self.mon_var] + self.mutable_l1.args
                ),
            ),
            (
                self.var,
    ...
    def test_add_mon_npv(self):
        tests = [
            ...
            (
                self.mon_npv,
                self.var,
                LinearExpression([self.mon_npv, self.mon_var]),
            ),
            (
                self.mon_npv,
                self.mon_native,
    ...
    def test_add_other(self):
        tests = [
            ...
            (
                self.other,
                self.mutable_l1,
                SumExpression([self.other, self.mon_npv]),
            ),
            (
                self.other,
                self.mutable_l2,
    ...
    def test_add_mutable_l1(self):
        tests = [
            ...
            (
                ...
                self.asbinary,
                LinearExpression(
                    self.mutable_l1.args + [self.mon_bin]
                ),
            ),
            ...
            (
                ...
                self.var,
                LinearExpression(
                    self.mutable_l1.args + [self.mon_var]
                ),
            ),
            (
                self.mutable_l1,
    ...
    def test_sub_asbinary(self):
        tests = [
            ...
            (
                ...
                self.param_mut,
                LinearExpression(
                    [self.mon_bin, self.minus_param_mut]
                ),
            ),
            # 8:
            (
            ...
            (
                ...
                self.mon_native,
                LinearExpression(
                    [self.mon_bin, self.minus_mon_native]
                ),
            ),
            (
                self.asbinary,
                self.mon_param,
                LinearExpression(
                    [self.mon_bin, self.minus_mon_param]
                ),
            ),
            (
                self.asbinary,
                self.mon_npv,
                LinearExpression(
                    [self.mon_bin, self.minus_mon_npv]
                ),
            ),
            # 12:
    ...
    def test_sub_var(self):
        tests = [
            ...
            (
                ...
                self.param_mut,
                LinearExpression(
                    [self.mon_var, self.minus_param_mut]
                ),
            ),
            # 8:
            (
            ...
            (
                ...
                self.mon_native,
                LinearExpression(
                    [self.mon_var, self.minus_mon_native]
                ),
            ),
            (
                self.var,
                self.mon_param,
                LinearExpression(
                    [self.mon_var, self.minus_mon_param]
                ),
            ),
            (
                self.var,
                self.mon_npv,
                LinearExpression(
                    [self.mon_var, self.minus_mon_npv]
                ),
            ),
            # 12:
            (
        ...
        tests = [
            ...
            (
                ...
                MonomialTermExpression(
                    (
                        NPV_ProductExpression(
                            (self.param_mut, self.mon_npv.arg(0))
                        ),
                        self.mon_npv.arg(1),
                    )
                ),
    ...
    def test_mul_var(self):
        tests = [
            ...
            (
                self.var,
                self.mutable_l1,
                ProductExpression((self.var, self.mon_npv)),
            ),
    ...
    def test_mul_sum(self):
        tests = [
            ...
            (
                self.sum,
                self.mutable_l1,
                ProductExpression((self.sum, self.mon_npv)),
            ),
    ...
    def test_mul_mutable_l1(self):
        tests = [
            ...
            (
                self.mutable_l1,
                self.var,
                ProductExpression((self.mon_npv, self.var)),
            ),
            (
                self.mutable_l1,
                self.mon_native,
            ...
            (
                self.mutable_l1,
                self.sum,
                ProductExpression((self.mon_npv, self.sum)),
            ),
            (
                self.mutable_l1,
                self.other,
    ...
    def test_div_zero(self):
        tests = [
            ...
            (
                self.zero,
                self.mutable_l1,
                DivisionExpression((0, self.mon_npv)),
            ),
    ...
    def test_div_one(self):
        tests = [
            ...
            (
                self.one,
                self.mutable_l1,
                DivisionExpression((1, self.mon_npv)),
            ),
    ...
    def test_div_native(self):
        tests = [
            ...
            (
                self.native,
                self.mutable_l1,
                DivisionExpression((5, self.mon_npv)),
            ),
    ...
    def test_div_param(self):
        tests = [
            ...
            (
                self.param,
                self.mutable_l1,
                DivisionExpression((6, self.mon_npv)),
            ),
    ...
    def test_div_var(self):
        tests = [
            ...
            (
                self.var,
                self.mutable_l1,
                DivisionExpression((self.var, self.mon_npv)),
            ),
            (
                self.var,
                self.mutable_l2,
    ...
    def test_div_sum(self):
        tests = [
            ...
            (
                self.sum,
                self.mutable_l1,
                DivisionExpression((self.sum, self.mon_npv)),
            ),
            (
                self.sum,
                self.mutable_l2,
    ...
    def test_div_mutable_l1(self):
        tests = [
            ...
            (
                self.mutable_l1,
                self.var,
                DivisionExpression((self.mon_npv, self.var)),
            ),
            (
                self.mutable_l1,
                self.mon_native,
            ...
            (
                self.mutable_l1,
                self.sum,
                DivisionExpression((self.mon_npv, self.sum)),
            ),
            (
                self.mutable_l1,
                self.other,
    ...
    def test_pow_asbinary(self):
        tests = [
            ...
            (
                self.asbinary,
                self.mutable_l1,
                PowExpression((self.bin, self.mon_npv)),
            ),
            (
                self.asbinary,
                self.mutable_l2,
    ...
    def test_pow_npv(self):
        tests = [
            ...
            (
                self.npv,
                self.mutable_l1,
                PowExpression((self.npv, self.mon_npv)),
            ),
    ...
    def test_pow_var(self):
        tests = [
            ...
            (
                self.var,
                self.mutable_l1,
                PowExpression((self.var, self.mon_npv)),
            ),
    ...
    def test_pow_linear(self):
        tests = [
            ...
            (
                self.linear,
                self.mutable_l1,
                PowExpression((self.linear, self.mon_npv)),
            ),
            (
                self.linear,
                self.mutable_l2,
    ...
    def test_pow_sum(self):
        tests = [
            ...
            (
                self.sum,
                self.mutable_l1,
                PowExpression((self.sum, self.mon_npv)),
            ),
    ...
    def test_pow_other(self):
        tests = [
            ...
            (
                self.other,
                self.mutable_l1,
                PowExpression((self.other, self.mon_npv)),
            ),
    ...
    def test_pow_mutable_l1(self):
        tests = [
            ...
            (
                self.mutable_l1,
                self.npv,
                PowExpression((self.mon_npv, self.npv)),
            ),
            ...
            (
                self.mutable_l1,
                self.var,
                PowExpression((self.mon_npv, self.var)),
            ),
            (
                self.mutable_l1,
                self.mon_native,
            ...
            (
                self.mutable_l1,
                self.linear,
                PowExpression((self.mon_npv, self.linear)),
            ),
            (
                self.mutable_l1,
                self.sum,
                PowExpression((self.mon_npv, self.sum)),
            ),
            (
                self.mutable_l1,
                self.other,
                PowExpression((self.mon_npv, self.other)),
            ),
