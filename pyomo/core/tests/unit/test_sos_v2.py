...
class TestSOS(unittest.TestCase):
    def test_nonindexedsos(self, show_output: bool = False):
        ...
        for sos, exp_res, abs_tol, use_rule, case in test_vectors:
            try:
                model = self.problem_nonindexed_sosn(
                    case=case, n=sos, use_rule=use_rule
                )
    ...
    def test_indexedsos(self, show_output: bool = False):
        ...
        for sos, exp_res, abs_tol, use_rule, case in test_vectors:
            try:
                model = self.problem_indexed_sosn(case=case, n=sos, use_rule=use_rule)
            except NotImplementedError:
                continue
    ...
    def test_nonindexedsos_multivar(self, show_output: bool = False):
        ...
        for sos, exp_res, abs_tol in test_vectors:
            try:
                model = self.problem_nonindexed_sosn_different_vars(n=sos)
            except NotImplementedError:
                continue
    ...
    def test_indexedsos_multivar(self, show_output: bool = False):
        ...
        for sos, exp_res, abs_tol in test_vectors:
            try:
                model = self.problem_indexed_sosn_different_vars(n=sos)
            except NotImplementedError:
                continue
    ...
    def problem_nonindexed_sosn_different_vars(self, n: int = 1):
        # concrete model
    ...
    def problem_indexed_sosn_different_vars(self, n: int = 1):
        # abstract model
    ...
    def problem_nonindexed_sosn(
        self, case: int == 0, n: int = 1, use_rule: bool = False
    ):
        # concrete model
    ...
    def problem_indexed_sosn(self, case: int == 0, n: int = 1, use_rule: bool = False):
        # abstract model
