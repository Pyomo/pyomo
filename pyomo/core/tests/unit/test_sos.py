...
class TestExamples(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.assertEqual(set((v.cname(True),w) for v,w in M.c.get_items()), set((M.x[i].cname(True), i) for i in xrange(20)))
    ...
    def test2(self):
        ...
        self.assertEqual(set((v.cname(True),w) for v,w in M.c.get_items()), set((M.x[i].cname(True), i) for i in xrange(10)))
    ...
    def test10(self):
        ...
        self.assertEqual(set((v.cname(True),w) for v,w in M.c[1].get_items()), set((M.x[i].cname(True), i) for i in [2,3]))
    ...
    def test13(self):
        ...
        self.assertEqual(set((v.cname(True),w) for v,w in M.c[1].get_items()), set((M.x[i].cname(True), i) for i in I[1]))
