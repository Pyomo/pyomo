    ...
    def test_le_mon_native(self):
        tests = [
            ...
            (
                self.mon_native,
                self.lt,
                RangedExpression((self.mon_native,) + self.le.args, (False, True)),
            ),
            # 24
            (
                self.mon_native,
    ...
    def test_le_linear(self):
        tests = [
            ...
            (
                self.linear,
                self.lt,
                RangedExpression(((self.linear,) + self.le.args), (False, True)),
            ),
            # 24
            (
                self.linear,
    ...
    def test_le_other(self):
        tests = [
            ...
            (
                self.other,
                self.lt,
                RangedExpression((self.other,) + self.le.args, (False, True)),
            ),
            # 24
            (
                self.other,
    ...
    def test_le_param0(self):
        tests = [
            ...
            (
                self.param0,
                self.lt,
                RangedExpression((0,) + self.le.args, (False, True)),
            ),
            # 24
            (
                self.param0,
