    ...
    def __next__(self):
        ...
        while True:
            ...
            while idx < len(self._slice._call_stack):
                ...
                if _call[0] == _IndexedComponent_slice.attribute:
                    try:
                        ...
                        break
                    self._iter_stack[idx] = None
                elif _call[0] == _IndexedComponent_slice.getitem:
                    try:
...
class _IndexedComponent_slice(object):
    ...
    def __getattr__(self, name):
        ...
        self._call_stack.append( (
            _IndexedComponent_slice.attribute, name ) )
        return self
    ...
    def __getitem__(self, *idx):
        ...
        """
        self._call_stack.append( (
            _IndexedComponent_slice.getitem, idx ) )
        return self
...
""" % (self.name,) )
    ...
    def __delitem__(self, index):
        ...
        if type(index) is _IndexedComponent_slice:
