...
class DummySolver1(pyomo.opt.OptSolver):

    def __init__(self, **kwds):
        kwds['type'] = 'stest_type'
        kwds['doc'] = 'DummySolver1 Documentation'
...
class OptSolverDebug(unittest.TestCase):
    ...
    def setUp(self):
        pyomo.opt.SolverFactory.register('stest1')(DummySolver1)
    ...
    def test_solver_init1(self):
        ...
        self.assertEqual(type(ans), DummySolver1)
        self.assertEqual(ans._doc, "DummySolver1 Documentation")
