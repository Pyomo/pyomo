...
_lr_productions = [
  ...
  ('expr -> statements','expr',1,'p_expr','parse_datacmds.py',218),
  ('expr -> <empty>','expr',0,'p_expr','parse_datacmds.py',219),
  ('statements -> statements statement','statements',2,'p_statements','parse_datacmds.py',234),
  ('statements -> statement','statements',1,'p_statements','parse_datacmds.py',235),
  ('statements -> statements NAMESPACE WORD LBRACE statements RBRACE','statements',6,'p_statements','parse_datacmds.py',236),
  ('statements -> NAMESPACE WORD LBRACE statements RBRACE','statements',5,'p_statements','parse_datacmds.py',237),
  ('statement -> SET WORD COLONEQ datastar SEMICOLON','statement',5,'p_statement','parse_datacmds.py',260),
  ('statement -> SET WORDWITHLBRACKET args RBRACKET COLONEQ datastar SEMICOLON','statement',7,'p_statement','parse_datacmds.py',261),
  ('statement -> SET WORD COLON itemstar COLONEQ datastar SEMICOLON','statement',7,'p_statement','parse_datacmds.py',262),
  ('statement -> PARAM items COLONEQ datastar SEMICOLON','statement',5,'p_statement','parse_datacmds.py',263),
  ('statement -> TABLE items COLONEQ datastar SEMICOLON','statement',5,'p_statement','parse_datacmds.py',264),
  ('statement -> LOAD items SEMICOLON','statement',3,'p_statement','parse_datacmds.py',265),
  ('statement -> STORE items SEMICOLON','statement',3,'p_statement','parse_datacmds.py',266),
  ('statement -> INCLUDE WORD SEMICOLON','statement',3,'p_statement','parse_datacmds.py',267),
  ('statement -> INCLUDE QUOTEDSTRING SEMICOLON','statement',3,'p_statement','parse_datacmds.py',268),
  ('statement -> DATA SEMICOLON','statement',2,'p_statement','parse_datacmds.py',269),
  ('statement -> END SEMICOLON','statement',2,'p_statement','parse_datacmds.py',270),
  ('datastar -> data','datastar',1,'p_datastar','parse_datacmds.py',300),
  ('datastar -> <empty>','datastar',0,'p_datastar','parse_datacmds.py',301),
  ('data -> data NUM_VAL','data',2,'p_data','parse_datacmds.py',311),
  ('data -> data WORD','data',2,'p_data','parse_datacmds.py',312),
  ('data -> data STRING','data',2,'p_data','parse_datacmds.py',313),
  ('data -> data QUOTEDSTRING','data',2,'p_data','parse_datacmds.py',314),
  ('data -> data BRACKETEDSTRING','data',2,'p_data','parse_datacmds.py',315),
  ('data -> data SET','data',2,'p_data','parse_datacmds.py',316),
  ('data -> data TABLE','data',2,'p_data','parse_datacmds.py',317),
  ('data -> data PARAM','data',2,'p_data','parse_datacmds.py',318),
  ('data -> data LPAREN','data',2,'p_data','parse_datacmds.py',319),
  ('data -> data RPAREN','data',2,'p_data','parse_datacmds.py',320),
  ('data -> data COMMA','data',2,'p_data','parse_datacmds.py',321),
  ('data -> data ASTERISK','data',2,'p_data','parse_datacmds.py',322),
  ('data -> NUM_VAL','data',1,'p_data','parse_datacmds.py',323),
  ('data -> WORD','data',1,'p_data','parse_datacmds.py',324),
  ('data -> STRING','data',1,'p_data','parse_datacmds.py',325),
  ('data -> QUOTEDSTRING','data',1,'p_data','parse_datacmds.py',326),
  ('data -> BRACKETEDSTRING','data',1,'p_data','parse_datacmds.py',327),
  ('data -> SET','data',1,'p_data','parse_datacmds.py',328),
  ('data -> TABLE','data',1,'p_data','parse_datacmds.py',329),
  ('data -> PARAM','data',1,'p_data','parse_datacmds.py',330),
  ('data -> LPAREN','data',1,'p_data','parse_datacmds.py',331),
  ('data -> RPAREN','data',1,'p_data','parse_datacmds.py',332),
  ('data -> COMMA','data',1,'p_data','parse_datacmds.py',333),
  ('data -> ASTERISK','data',1,'p_data','parse_datacmds.py',334),
  ('args -> arg','args',1,'p_args','parse_datacmds.py',358),
  ('args -> <empty>','args',0,'p_args','parse_datacmds.py',359),
  ('arg -> arg COMMA NUM_VAL','arg',3,'p_arg','parse_datacmds.py',369),
  ('arg -> arg COMMA WORD','arg',3,'p_arg','parse_datacmds.py',370),
  ('arg -> arg COMMA STRING','arg',3,'p_arg','parse_datacmds.py',371),
  ('arg -> arg COMMA QUOTEDSTRING','arg',3,'p_arg','parse_datacmds.py',372),
  ('arg -> arg COMMA SET','arg',3,'p_arg','parse_datacmds.py',373),
  ('arg -> arg COMMA TABLE','arg',3,'p_arg','parse_datacmds.py',374),
  ('arg -> arg COMMA PARAM','arg',3,'p_arg','parse_datacmds.py',375),
  ('arg -> NUM_VAL','arg',1,'p_arg','parse_datacmds.py',376),
  ('arg -> WORD','arg',1,'p_arg','parse_datacmds.py',377),
  ('arg -> STRING','arg',1,'p_arg','parse_datacmds.py',378),
  ('arg -> QUOTEDSTRING','arg',1,'p_arg','parse_datacmds.py',379),
  ('arg -> SET','arg',1,'p_arg','parse_datacmds.py',380),
  ('arg -> TABLE','arg',1,'p_arg','parse_datacmds.py',381),
  ('arg -> PARAM','arg',1,'p_arg','parse_datacmds.py',382),
  ('itemstar -> items','itemstar',1,'p_itemstar','parse_datacmds.py',412),
  ('itemstar -> <empty>','itemstar',0,'p_itemstar','parse_datacmds.py',413),
  ('items -> items NUM_VAL','items',2,'p_items','parse_datacmds.py',423),
  ('items -> items WORD','items',2,'p_items','parse_datacmds.py',424),
  ('items -> items STRING','items',2,'p_items','parse_datacmds.py',425),
  ('items -> items QUOTEDSTRING','items',2,'p_items','parse_datacmds.py',426),
  ('items -> items COMMA','items',2,'p_items','parse_datacmds.py',427),
  ('items -> items COLON','items',2,'p_items','parse_datacmds.py',428),
  ('items -> items LBRACE','items',2,'p_items','parse_datacmds.py',429),
  ('items -> items RBRACE','items',2,'p_items','parse_datacmds.py',430),
  ('items -> items LBRACKET','items',2,'p_items','parse_datacmds.py',431),
  ('items -> items RBRACKET','items',2,'p_items','parse_datacmds.py',432),
  ('items -> items TR','items',2,'p_items','parse_datacmds.py',433),
  ('items -> items LPAREN','items',2,'p_items','parse_datacmds.py',434),
  ('items -> items RPAREN','items',2,'p_items','parse_datacmds.py',435),
  ('items -> items ASTERISK','items',2,'p_items','parse_datacmds.py',436),
  ('items -> items EQ','items',2,'p_items','parse_datacmds.py',437),
  ('items -> items SET','items',2,'p_items','parse_datacmds.py',438),
  ('items -> items TABLE','items',2,'p_items','parse_datacmds.py',439),
  ('items -> items PARAM','items',2,'p_items','parse_datacmds.py',440),
  ('items -> NUM_VAL','items',1,'p_items','parse_datacmds.py',441),
  ('items -> WORD','items',1,'p_items','parse_datacmds.py',442),
  ('items -> STRING','items',1,'p_items','parse_datacmds.py',443),
  ('items -> QUOTEDSTRING','items',1,'p_items','parse_datacmds.py',444),
  ('items -> COMMA','items',1,'p_items','parse_datacmds.py',445),
  ('items -> COLON','items',1,'p_items','parse_datacmds.py',446),
  ('items -> LBRACKET','items',1,'p_items','parse_datacmds.py',447),
  ('items -> RBRACKET','items',1,'p_items','parse_datacmds.py',448),
  ('items -> LBRACE','items',1,'p_items','parse_datacmds.py',449),
  ('items -> RBRACE','items',1,'p_items','parse_datacmds.py',450),
  ('items -> TR','items',1,'p_items','parse_datacmds.py',451),
  ('items -> LPAREN','items',1,'p_items','parse_datacmds.py',452),
  ('items -> RPAREN','items',1,'p_items','parse_datacmds.py',453),
  ('items -> ASTERISK','items',1,'p_items','parse_datacmds.py',454),
  ('items -> EQ','items',1,'p_items','parse_datacmds.py',455),
  ('items -> SET','items',1,'p_items','parse_datacmds.py',456),
  ('items -> TABLE','items',1,'p_items','parse_datacmds.py',457),
  ('items -> PARAM','items',1,'p_items','parse_datacmds.py',458),
]
