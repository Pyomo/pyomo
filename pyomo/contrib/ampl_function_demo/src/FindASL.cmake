...
SET(AMPL_ASL_TAG "9fb7cb8e4f68ed1c3bc066d191e63698b7d7d1d2" CACHE STRING
  "AMPL/asl git tag/branch to checkout and build")
# 9fb7cb8e4f68ed1c3bc066d191e63698b7d7d1d2 corresponds to ASLdate = 20211109
OPTION(BUILD_AMPL_ASL
  "Download and build AMPL/asl ${AMPL_ASL_TAG} from GitHub" OFF)

# Other build / environment options
OPTION(BUILD_AMPL_ASL_IF_NEEDED
  "Automatically enable AMPL/asl build if ASL not found" OFF)
MARK_AS_ADVANCED(BUILD_AMPL_ASL_IF_NEEDED)
...
SET(AMPL_ASL_DIR "" CACHE PATH "Path to compiled AMPL/asl installation")
...
# If BUILD_AMPL_ASL_IF_NEEDED is set and we couldn't find / weren't
# pointed to an ASL build, then we will forcibly enable the AMPL/asl build
# to provide the ASL.
IF( BUILD_AMPL_ASL_IF_NEEDED AND (NOT ASL_LIBRARY OR NOT ASL_INCLUDE_DIR) )
    set_property(CACHE BUILD_AMPL_ASL PROPERTY VALUE ON)
ENDIF()

IF( BUILD_AMPL_ASL )
  get_filename_component(ABS_INSTALL_PREFIX "${CMAKE_INSTALL_PREFIX}" ABSOLUTE)
  ExternalProject_Add(ampl_asl
    GIT_TAG ${AMPL_ASL_TAG}
