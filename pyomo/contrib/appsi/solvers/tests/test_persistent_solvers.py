...
from pyomo.contrib.appsi.solvers import Gurobi, Ipopt, Cplex, Cbc, Highs, Copt
...
qcp_solvers = [('gurobi', Gurobi), ('ipopt', Ipopt), ('cplex', Cplex), ('copt', Copt)]
miqcqp_solvers = [('gurobi', Gurobi), ('cplex', Cplex), ('copt', Copt)]
