...
class TestPrecedenceRelationships(unittest.TestCase):
    ...
    def test_start_before_start(self):
        ...
        self.assertIsInstance(m.c.expr, StartBeforeStartExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertEqual(m.c.expr.nargs(), 3)
        self.assertIs(m.c.expr.args[0], m.a)
        self.assertIs(m.c.expr.args[1], m.b)
    ...
    def test_start_before_end(self):
        ...
        self.assertIsInstance(m.c.expr, StartBeforeEndExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertEqual(m.c.expr.nargs(), 3)
        self.assertIs(m.c.expr.args[0], m.a)
        self.assertIs(m.c.expr.args[1], m.b)
    ...
    def test_start_after_start(self):
        ...
        self.assertIsInstance(m.c.expr, StartBeforeStartExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertIs(m.c.expr.args[0], m.b)
        self.assertIs(m.c.expr.args[1], m.a)
        self.assertEqual(m.c.expr.delay, 0)
    ...
    def test_start_after_end(self):
        ...
        self.assertIsInstance(m.c.expr, EndBeforeStartExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertIs(m.c.expr.args[0], m.b)
        self.assertIs(m.c.expr.args[1], m.a)
    ...
    def test_start_at_start(self):
        ...
        self.assertIsInstance(m.c.expr, StartAtStartExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertEqual(m.c.expr.nargs(), 3)
        self.assertIs(m.c.expr.args[0], m.a)
        self.assertIs(m.c.expr.args[1], m.b)
    ...
    def test_start_at_end(self):
        ...
        self.assertIsInstance(m.c.expr, StartAtEndExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertEqual(m.c.expr.nargs(), 3)
        self.assertIs(m.c.expr.args[0], m.a)
        self.assertIs(m.c.expr.args[1], m.b)
    ...
    def test_end_at_start(self):
        ...
        self.assertIsInstance(m.c.expr, EndAtStartExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertIs(m.c.expr.args[0], m.a)
        self.assertIs(m.c.expr.args[1], m.b)
    ...
    def test_end_before_end(self):
        ...
        self.assertIsInstance(m.c.expr, EndBeforeEndExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertIs(m.c.expr.args[0], m.a)
        self.assertIs(m.c.expr.args[1], m.b)
    ...
    def test_end_at_end(self):
        ...
        self.assertIsInstance(m.c.expr, EndAtEndExpression)
        self.assertEqual(len(m.c.expr.args), 3)
        self.assertIs(m.c.expr.args[0], m.a)
        self.assertIs(m.c.expr.args[1], m.b)
        self.assertEqual(m.c.expr.delay, -3)
