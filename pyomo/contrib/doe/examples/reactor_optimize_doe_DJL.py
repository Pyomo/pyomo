...
def get_exp_results(m):
    vals = [aml.value(m.CA0[0]), ]
    for i in [0, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1]:
        vals.append(aml.value(m.T[i]))
    return vals


def get_FIM_from_exp(CA_0=None, T_0=None, prior=None):
    if CA_0 is None:
        CA_0 = 5
    if T_0 is None:
        T_0 = [570, 300, 300, 300, 300, 300, 300, 300, 300]
    ### Define inputs
    # Control time set [h]
    ...
    exp_design.add_variables(
        ...
        values=[CA_0],  # nominal value of design variable
    ...
    exp_design.add_variables(
        ...
        time_index_position=0,  # position of time index
        values=list(T_0),  # nominal value of design variable
...
def main(CA_0=None, T_0=None, prior=None):
    if CA_0 is None:
        CA_0 = 5
    if T_0 is None:
        T_0 = [570, 300, 300, 300, 300, 300, 300, 300, 300]
    ...
    return prior, optimize_result, square_result
