...
class TestMeasurement(unittest.TestCase):
    ...
    def test_setup(self):
        ...
        measure_pass = {
            'C': {"CA": t_measure_ca, "CB": t_measure_cb, "CC": t_measure_cc}
        }
        ...
        self.assertEqual(
            measure_class.flatten_measure_name,
            ['C_index_CA', 'C_index_CB', 'C_index_CC'],
        )
        self.assertEqual(
            measure_class.flatten_variance,
            {'C_index_CA': 5, 'C_index_CB': 2, 'C_index_CC': 1},
        )
        self.assertEqual(
            measure_class.flatten_measure_timeset['C_index_CB'], [0, 0.25, 0.5, 0.75, 1]
        )
...
class TestParameter(unittest.TestCase):
    ...
    def test_setup(self):
        ...
        self.assertAlmostEqual(
            scenario_gene.next_sequential_scenario(2)['E1'][0], 8.558, places=1
        )
