...
class FIM_result:
    ...
    def calculate_FIM(self, dv_values, result=None):
        ...
        q1[:,0] = self.jaco_information['fitted_transport_coefficient'][:69]
        q1[:,1] = self.jaco_information['ua'][:69]
        q2[:,0] = self.jaco_information['fitted_transport_coefficient'][69:138]
        q2[:,1] = self.jaco_information['ua'][69:138]
        q3[:,0] = self.jaco_information['fitted_transport_coefficient'][138:207]
        q3[:,1] = self.jaco_information['ua'][138:207]

        
        
        fim = 10000*q1.T@q1 + q2.T@q2 + q3.T@q3
        #fim = 10000*q1.T@q1
        #fim = 10000*q1.T@q1 + q2.T@q2
    ...
    def __split_jacobian(self, measurement_subset):
        ...
        jaco_3D = self.__jac_reform_3D(self.jaco_information)
