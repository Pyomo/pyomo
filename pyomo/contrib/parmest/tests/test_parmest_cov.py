...
# Test class for when the user wants to use the built-in Parmest SSE objective function
@unittest.skipIf(not ipopt_available, "The 'ipopt' command is not available")
class TestRooneyBieglerSSE(unittest.TestCase):
    def setUp(self):
...
# Test class for when the user wants to use the built-in Parmest SSE_weighted objective function
@unittest.skipIf(not ipopt_available, "The 'ipopt' command is not available")
class TestRooneyBieglerWSSE(unittest.TestCase):
    def setUp(self):
        ...
        self.data = data
        self.pest = parmest.Estimator(
            exp_list, obj_function="SSE_weighted", solver_options=solver_options, tee=True
        )
...
# # Test class for when the user supply their SSE objective function
# @unittest.skipIf(not ipopt_available, "The 'ipopt' command is not available")
