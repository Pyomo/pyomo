...
# Same example as bootstrap_example.py minus additional import belowt
...
def main():
    ...
    bootstrap_theta = pest.theta_est_bootstrap(50, seed=524)  # Set a seed for reproducibility   
