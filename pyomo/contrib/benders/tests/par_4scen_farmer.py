...
def test_farmer():
    ...
    assert round(m.devoted_acreage['CORN'].value - 100, 7) == 0
    assert round(m.devoted_acreage['SUGAR_BEETS'].value - 250, 7) == 0
    assert round(m.devoted_acreage['WHEAT'].value - 150, 7) == 0
