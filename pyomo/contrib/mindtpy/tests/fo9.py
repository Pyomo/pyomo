...
m.c43 = Constraint(expr= - 12*m.b1 - 12*m.b2 + 0.5*m.x146 + 0.5*m.x147 - m.x166 + m.x167 <= 0)

m.c44 = Constraint(expr= - 12*m.b1 + 12*m.b2 + 0.5*m.x146 + 0.5*m.x147 + m.x166 - m.x167 <= 12)

m.c45 = Constraint(expr=   13*m.b1 - 13*m.b2 + 0.5*m.x156 + 0.5*m.x157 - m.x175 + m.x176 <= 13)

m.c46 = Constraint(expr=   13*m.b1 + 13*m.b2 + 0.5*m.x156 + 0.5*m.x157 + m.x175 - m.x176 <= 26)
...
m.c51 = Constraint(expr= - 12*m.b3 - 12*m.b4 + 0.5*m.x146 + 0.5*m.x148 - m.x166 + m.x168 <= 0)

m.c52 = Constraint(expr= - 12*m.b3 + 12*m.b4 + 0.5*m.x146 + 0.5*m.x148 + m.x166 - m.x168 <= 12)

m.c53 = Constraint(expr=   13*m.b3 - 13*m.b4 + 0.5*m.x156 + 0.5*m.x158 - m.x175 + m.x177 <= 13)

m.c54 = Constraint(expr=   13*m.b3 + 13*m.b4 + 0.5*m.x156 + 0.5*m.x158 + m.x175 - m.x177 <= 26)
...
m.c59 = Constraint(expr= - 12*m.b5 - 12*m.b6 + 0.5*m.x146 + 0.5*m.x149 - m.x166 + m.x169 <= 0)

m.c60 = Constraint(expr= - 12*m.b5 + 12*m.b6 + 0.5*m.x146 + 0.5*m.x149 + m.x166 - m.x169 <= 12)

m.c61 = Constraint(expr=   13*m.b5 - 13*m.b6 + 0.5*m.x156 + 0.5*m.x159 - m.x175 + m.x178 <= 13)

m.c62 = Constraint(expr=   13*m.b5 + 13*m.b6 + 0.5*m.x156 + 0.5*m.x159 + m.x175 - m.x178 <= 26)
...
m.c67 = Constraint(expr= - 12*m.b7 - 12*m.b8 + 0.5*m.x146 + 0.5*m.x150 - m.x166 + m.x170 <= 0)

m.c68 = Constraint(expr= - 12*m.b7 + 12*m.b8 + 0.5*m.x146 + 0.5*m.x150 + m.x166 - m.x170 <= 12)

m.c69 = Constraint(expr=   13*m.b7 - 13*m.b8 + 0.5*m.x156 + 0.5*m.x160 - m.x175 + m.x179 <= 13)

m.c70 = Constraint(expr=   13*m.b7 + 13*m.b8 + 0.5*m.x156 + 0.5*m.x160 + m.x175 - m.x179 <= 26)
...
m.c75 = Constraint(expr= - 12*m.b9 - 12*m.b10 + 0.5*m.x146 + 0.5*m.x151 - m.x166 + m.x171 <= 0)

m.c76 = Constraint(expr= - 12*m.b9 + 12*m.b10 + 0.5*m.x146 + 0.5*m.x151 + m.x166 - m.x171 <= 12)

m.c77 = Constraint(expr=   13*m.b9 - 13*m.b10 + 0.5*m.x156 + 0.5*m.x161 - m.x175 + m.x180 <= 13)

m.c78 = Constraint(expr=   13*m.b9 + 13*m.b10 + 0.5*m.x156 + 0.5*m.x161 + m.x175 - m.x180 <= 26)
...
m.c83 = Constraint(expr= - 12*m.b11 - 12*m.b12 + 0.5*m.x146 + 0.5*m.x152 - m.x166 + m.x172 <= 0)

m.c84 = Constraint(expr= - 12*m.b11 + 12*m.b12 + 0.5*m.x146 + 0.5*m.x152 + m.x166 - m.x172 <= 12)

m.c85 = Constraint(expr=   13*m.b11 - 13*m.b12 + 0.5*m.x156 + 0.5*m.x162 - m.x175 + m.x181 <= 13)

m.c86 = Constraint(expr=   13*m.b11 + 13*m.b12 + 0.5*m.x156 + 0.5*m.x162 + m.x175 - m.x181 <= 26)
...
m.c91 = Constraint(expr= - 12*m.b13 - 12*m.b14 + 0.5*m.x146 + 0.5*m.x153 - m.x166 + m.x173 <= 0)

m.c92 = Constraint(expr= - 12*m.b13 + 12*m.b14 + 0.5*m.x146 + 0.5*m.x153 + m.x166 - m.x173 <= 12)

m.c93 = Constraint(expr=   13*m.b13 - 13*m.b14 + 0.5*m.x156 + 0.5*m.x163 - m.x175 + m.x182 <= 13)

m.c94 = Constraint(expr=   13*m.b13 + 13*m.b14 + 0.5*m.x156 + 0.5*m.x163 + m.x175 - m.x182 <= 26)
...
m.c99 = Constraint(expr= - 12*m.b15 - 12*m.b16 + 0.5*m.x146 + 0.5*m.x154 - m.x166 + m.x174 <= 0)

m.c100 = Constraint(expr= - 12*m.b15 + 12*m.b16 + 0.5*m.x146 + 0.5*m.x154 + m.x166 - m.x174 <= 12)

m.c101 = Constraint(expr=   13*m.b15 - 13*m.b16 + 0.5*m.x156 + 0.5*m.x164 - m.x175 + m.x183 <= 13)

m.c102 = Constraint(expr=   13*m.b15 + 13*m.b16 + 0.5*m.x156 + 0.5*m.x164 + m.x175 - m.x183 <= 26)
...
m.c107 = Constraint(expr= - 12*m.b17 - 12*m.b18 + 0.5*m.x147 + 0.5*m.x148 - m.x167 + m.x168 <= 0)

m.c108 = Constraint(expr= - 12*m.b17 + 12*m.b18 + 0.5*m.x147 + 0.5*m.x148 + m.x167 - m.x168 <= 12)

m.c109 = Constraint(expr=   13*m.b17 - 13*m.b18 + 0.5*m.x157 + 0.5*m.x158 - m.x176 + m.x177 <= 13)

m.c110 = Constraint(expr=   13*m.b17 + 13*m.b18 + 0.5*m.x157 + 0.5*m.x158 + m.x176 - m.x177 <= 26)
...
m.c115 = Constraint(expr= - 12*m.b19 - 12*m.b20 + 0.5*m.x147 + 0.5*m.x149 - m.x167 + m.x169 <= 0)

m.c116 = Constraint(expr= - 12*m.b19 + 12*m.b20 + 0.5*m.x147 + 0.5*m.x149 + m.x167 - m.x169 <= 12)

m.c117 = Constraint(expr=   13*m.b19 - 13*m.b20 + 0.5*m.x157 + 0.5*m.x159 - m.x176 + m.x178 <= 13)

m.c118 = Constraint(expr=   13*m.b19 + 13*m.b20 + 0.5*m.x157 + 0.5*m.x159 + m.x176 - m.x178 <= 26)
...
m.c123 = Constraint(expr= - 12*m.b21 - 12*m.b22 + 0.5*m.x147 + 0.5*m.x150 - m.x167 + m.x170 <= 0)

m.c124 = Constraint(expr= - 12*m.b21 + 12*m.b22 + 0.5*m.x147 + 0.5*m.x150 + m.x167 - m.x170 <= 12)

m.c125 = Constraint(expr=   13*m.b21 - 13*m.b22 + 0.5*m.x157 + 0.5*m.x160 - m.x176 + m.x179 <= 13)

m.c126 = Constraint(expr=   13*m.b21 + 13*m.b22 + 0.5*m.x157 + 0.5*m.x160 + m.x176 - m.x179 <= 26)
...
m.c131 = Constraint(expr= - 12*m.b23 - 12*m.b24 + 0.5*m.x147 + 0.5*m.x151 - m.x167 + m.x171 <= 0)

m.c132 = Constraint(expr= - 12*m.b23 + 12*m.b24 + 0.5*m.x147 + 0.5*m.x151 + m.x167 - m.x171 <= 12)

m.c133 = Constraint(expr=   13*m.b23 - 13*m.b24 + 0.5*m.x157 + 0.5*m.x161 - m.x176 + m.x180 <= 13)

m.c134 = Constraint(expr=   13*m.b23 + 13*m.b24 + 0.5*m.x157 + 0.5*m.x161 + m.x176 - m.x180 <= 26)
...
m.c139 = Constraint(expr= - 12*m.b25 - 12*m.b26 + 0.5*m.x147 + 0.5*m.x152 - m.x167 + m.x172 <= 0)

m.c140 = Constraint(expr= - 12*m.b25 + 12*m.b26 + 0.5*m.x147 + 0.5*m.x152 + m.x167 - m.x172 <= 12)

m.c141 = Constraint(expr=   13*m.b25 - 13*m.b26 + 0.5*m.x157 + 0.5*m.x162 - m.x176 + m.x181 <= 13)

m.c142 = Constraint(expr=   13*m.b25 + 13*m.b26 + 0.5*m.x157 + 0.5*m.x162 + m.x176 - m.x181 <= 26)
...
m.c147 = Constraint(expr= - 12*m.b27 - 12*m.b28 + 0.5*m.x147 + 0.5*m.x153 - m.x167 + m.x173 <= 0)

m.c148 = Constraint(expr= - 12*m.b27 + 12*m.b28 + 0.5*m.x147 + 0.5*m.x153 + m.x167 - m.x173 <= 12)

m.c149 = Constraint(expr=   13*m.b27 - 13*m.b28 + 0.5*m.x157 + 0.5*m.x163 - m.x176 + m.x182 <= 13)

m.c150 = Constraint(expr=   13*m.b27 + 13*m.b28 + 0.5*m.x157 + 0.5*m.x163 + m.x176 - m.x182 <= 26)
...
m.c155 = Constraint(expr= - 12*m.b29 - 12*m.b30 + 0.5*m.x147 + 0.5*m.x154 - m.x167 + m.x174 <= 0)

m.c156 = Constraint(expr= - 12*m.b29 + 12*m.b30 + 0.5*m.x147 + 0.5*m.x154 + m.x167 - m.x174 <= 12)

m.c157 = Constraint(expr=   13*m.b29 - 13*m.b30 + 0.5*m.x157 + 0.5*m.x164 - m.x176 + m.x183 <= 13)

m.c158 = Constraint(expr=   13*m.b29 + 13*m.b30 + 0.5*m.x157 + 0.5*m.x164 + m.x176 - m.x183 <= 26)
...
m.c163 = Constraint(expr= - 12*m.b31 - 12*m.b32 + 0.5*m.x148 + 0.5*m.x149 - m.x168 + m.x169 <= 0)

m.c164 = Constraint(expr= - 12*m.b31 + 12*m.b32 + 0.5*m.x148 + 0.5*m.x149 + m.x168 - m.x169 <= 12)

m.c165 = Constraint(expr=   13*m.b31 - 13*m.b32 + 0.5*m.x158 + 0.5*m.x159 - m.x177 + m.x178 <= 13)

m.c166 = Constraint(expr=   13*m.b31 + 13*m.b32 + 0.5*m.x158 + 0.5*m.x159 + m.x177 - m.x178 <= 26)
...
m.c171 = Constraint(expr= - 12*m.b33 - 12*m.b34 + 0.5*m.x148 + 0.5*m.x150 - m.x168 + m.x170 <= 0)

m.c172 = Constraint(expr= - 12*m.b33 + 12*m.b34 + 0.5*m.x148 + 0.5*m.x150 + m.x168 - m.x170 <= 12)

m.c173 = Constraint(expr=   13*m.b33 - 13*m.b34 + 0.5*m.x158 + 0.5*m.x160 - m.x177 + m.x179 <= 13)

m.c174 = Constraint(expr=   13*m.b33 + 13*m.b34 + 0.5*m.x158 + 0.5*m.x160 + m.x177 - m.x179 <= 26)
...
m.c179 = Constraint(expr= - 12*m.b35 - 12*m.b36 + 0.5*m.x148 + 0.5*m.x151 - m.x168 + m.x171 <= 0)

m.c180 = Constraint(expr= - 12*m.b35 + 12*m.b36 + 0.5*m.x148 + 0.5*m.x151 + m.x168 - m.x171 <= 12)

m.c181 = Constraint(expr=   13*m.b35 - 13*m.b36 + 0.5*m.x158 + 0.5*m.x161 - m.x177 + m.x180 <= 13)

m.c182 = Constraint(expr=   13*m.b35 + 13*m.b36 + 0.5*m.x158 + 0.5*m.x161 + m.x177 - m.x180 <= 26)
...
m.c187 = Constraint(expr= - 12*m.b37 - 12*m.b38 + 0.5*m.x148 + 0.5*m.x152 - m.x168 + m.x172 <= 0)

m.c188 = Constraint(expr= - 12*m.b37 + 12*m.b38 + 0.5*m.x148 + 0.5*m.x152 + m.x168 - m.x172 <= 12)

m.c189 = Constraint(expr=   13*m.b37 - 13*m.b38 + 0.5*m.x158 + 0.5*m.x162 - m.x177 + m.x181 <= 13)

m.c190 = Constraint(expr=   13*m.b37 + 13*m.b38 + 0.5*m.x158 + 0.5*m.x162 + m.x177 - m.x181 <= 26)
...
m.c195 = Constraint(expr= - 12*m.b39 - 12*m.b40 + 0.5*m.x148 + 0.5*m.x153 - m.x168 + m.x173 <= 0)

m.c196 = Constraint(expr= - 12*m.b39 + 12*m.b40 + 0.5*m.x148 + 0.5*m.x153 + m.x168 - m.x173 <= 12)

m.c197 = Constraint(expr=   13*m.b39 - 13*m.b40 + 0.5*m.x158 + 0.5*m.x163 - m.x177 + m.x182 <= 13)

m.c198 = Constraint(expr=   13*m.b39 + 13*m.b40 + 0.5*m.x158 + 0.5*m.x163 + m.x177 - m.x182 <= 26)
...
m.c203 = Constraint(expr= - 12*m.b41 - 12*m.b42 + 0.5*m.x148 + 0.5*m.x154 - m.x168 + m.x174 <= 0)

m.c204 = Constraint(expr= - 12*m.b41 + 12*m.b42 + 0.5*m.x148 + 0.5*m.x154 + m.x168 - m.x174 <= 12)

m.c205 = Constraint(expr=   13*m.b41 - 13*m.b42 + 0.5*m.x158 + 0.5*m.x164 - m.x177 + m.x183 <= 13)

m.c206 = Constraint(expr=   13*m.b41 + 13*m.b42 + 0.5*m.x158 + 0.5*m.x164 + m.x177 - m.x183 <= 26)
...
m.c211 = Constraint(expr= - 12*m.b43 - 12*m.b44 + 0.5*m.x149 + 0.5*m.x150 - m.x169 + m.x170 <= 0)

m.c212 = Constraint(expr= - 12*m.b43 + 12*m.b44 + 0.5*m.x149 + 0.5*m.x150 + m.x169 - m.x170 <= 12)

m.c213 = Constraint(expr=   13*m.b43 - 13*m.b44 + 0.5*m.x159 + 0.5*m.x160 - m.x178 + m.x179 <= 13)

m.c214 = Constraint(expr=   13*m.b43 + 13*m.b44 + 0.5*m.x159 + 0.5*m.x160 + m.x178 - m.x179 <= 26)
...
m.c219 = Constraint(expr= - 12*m.b45 - 12*m.b46 + 0.5*m.x149 + 0.5*m.x151 - m.x169 + m.x171 <= 0)

m.c220 = Constraint(expr= - 12*m.b45 + 12*m.b46 + 0.5*m.x149 + 0.5*m.x151 + m.x169 - m.x171 <= 12)

m.c221 = Constraint(expr=   13*m.b45 - 13*m.b46 + 0.5*m.x159 + 0.5*m.x161 - m.x178 + m.x180 <= 13)

m.c222 = Constraint(expr=   13*m.b45 + 13*m.b46 + 0.5*m.x159 + 0.5*m.x161 + m.x178 - m.x180 <= 26)
...
m.c227 = Constraint(expr= - 12*m.b47 - 12*m.b48 + 0.5*m.x149 + 0.5*m.x152 - m.x169 + m.x172 <= 0)

m.c228 = Constraint(expr= - 12*m.b47 + 12*m.b48 + 0.5*m.x149 + 0.5*m.x152 + m.x169 - m.x172 <= 12)

m.c229 = Constraint(expr=   13*m.b47 - 13*m.b48 + 0.5*m.x159 + 0.5*m.x162 - m.x178 + m.x181 <= 13)

m.c230 = Constraint(expr=   13*m.b47 + 13*m.b48 + 0.5*m.x159 + 0.5*m.x162 + m.x178 - m.x181 <= 26)
...
m.c235 = Constraint(expr= - 12*m.b49 - 12*m.b50 + 0.5*m.x149 + 0.5*m.x153 - m.x169 + m.x173 <= 0)

m.c236 = Constraint(expr= - 12*m.b49 + 12*m.b50 + 0.5*m.x149 + 0.5*m.x153 + m.x169 - m.x173 <= 12)

m.c237 = Constraint(expr=   13*m.b49 - 13*m.b50 + 0.5*m.x159 + 0.5*m.x163 - m.x178 + m.x182 <= 13)

m.c238 = Constraint(expr=   13*m.b49 + 13*m.b50 + 0.5*m.x159 + 0.5*m.x163 + m.x178 - m.x182 <= 26)
...
m.c243 = Constraint(expr= - 12*m.b51 - 12*m.b52 + 0.5*m.x149 + 0.5*m.x154 - m.x169 + m.x174 <= 0)

m.c244 = Constraint(expr= - 12*m.b51 + 12*m.b52 + 0.5*m.x149 + 0.5*m.x154 + m.x169 - m.x174 <= 12)

m.c245 = Constraint(expr=   13*m.b51 - 13*m.b52 + 0.5*m.x159 + 0.5*m.x164 - m.x178 + m.x183 <= 13)

m.c246 = Constraint(expr=   13*m.b51 + 13*m.b52 + 0.5*m.x159 + 0.5*m.x164 + m.x178 - m.x183 <= 26)
...
m.c251 = Constraint(expr= - 12*m.b53 - 12*m.b54 + 0.5*m.x150 + 0.5*m.x151 - m.x170 + m.x171 <= 0)

m.c252 = Constraint(expr= - 12*m.b53 + 12*m.b54 + 0.5*m.x150 + 0.5*m.x151 + m.x170 - m.x171 <= 12)

m.c253 = Constraint(expr=   13*m.b53 - 13*m.b54 + 0.5*m.x160 + 0.5*m.x161 - m.x179 + m.x180 <= 13)

m.c254 = Constraint(expr=   13*m.b53 + 13*m.b54 + 0.5*m.x160 + 0.5*m.x161 + m.x179 - m.x180 <= 26)
...
m.c259 = Constraint(expr= - 12*m.b55 - 12*m.b56 + 0.5*m.x150 + 0.5*m.x152 - m.x170 + m.x172 <= 0)

m.c260 = Constraint(expr= - 12*m.b55 + 12*m.b56 + 0.5*m.x150 + 0.5*m.x152 + m.x170 - m.x172 <= 12)

m.c261 = Constraint(expr=   13*m.b55 - 13*m.b56 + 0.5*m.x160 + 0.5*m.x162 - m.x179 + m.x181 <= 13)

m.c262 = Constraint(expr=   13*m.b55 + 13*m.b56 + 0.5*m.x160 + 0.5*m.x162 + m.x179 - m.x181 <= 26)
...
m.c267 = Constraint(expr= - 12*m.b57 - 12*m.b58 + 0.5*m.x150 + 0.5*m.x153 - m.x170 + m.x173 <= 0)

m.c268 = Constraint(expr= - 12*m.b57 + 12*m.b58 + 0.5*m.x150 + 0.5*m.x153 + m.x170 - m.x173 <= 12)

m.c269 = Constraint(expr=   13*m.b57 - 13*m.b58 + 0.5*m.x160 + 0.5*m.x163 - m.x179 + m.x182 <= 13)

m.c270 = Constraint(expr=   13*m.b57 + 13*m.b58 + 0.5*m.x160 + 0.5*m.x163 + m.x179 - m.x182 <= 26)
...
m.c275 = Constraint(expr= - 12*m.b59 - 12*m.b60 + 0.5*m.x150 + 0.5*m.x154 - m.x170 + m.x174 <= 0)

m.c276 = Constraint(expr= - 12*m.b59 + 12*m.b60 + 0.5*m.x150 + 0.5*m.x154 + m.x170 - m.x174 <= 12)

m.c277 = Constraint(expr=   13*m.b59 - 13*m.b60 + 0.5*m.x160 + 0.5*m.x164 - m.x179 + m.x183 <= 13)

m.c278 = Constraint(expr=   13*m.b59 + 13*m.b60 + 0.5*m.x160 + 0.5*m.x164 + m.x179 - m.x183 <= 26)
...
m.c283 = Constraint(expr= - 12*m.b61 - 12*m.b62 + 0.5*m.x151 + 0.5*m.x152 - m.x171 + m.x172 <= 0)

m.c284 = Constraint(expr= - 12*m.b61 + 12*m.b62 + 0.5*m.x151 + 0.5*m.x152 + m.x171 - m.x172 <= 12)

m.c285 = Constraint(expr=   13*m.b61 - 13*m.b62 + 0.5*m.x161 + 0.5*m.x162 - m.x180 + m.x181 <= 13)

m.c286 = Constraint(expr=   13*m.b61 + 13*m.b62 + 0.5*m.x161 + 0.5*m.x162 + m.x180 - m.x181 <= 26)
...
m.c291 = Constraint(expr= - 12*m.b63 - 12*m.b64 + 0.5*m.x151 + 0.5*m.x153 - m.x171 + m.x173 <= 0)

m.c292 = Constraint(expr= - 12*m.b63 + 12*m.b64 + 0.5*m.x151 + 0.5*m.x153 + m.x171 - m.x173 <= 12)

m.c293 = Constraint(expr=   13*m.b63 - 13*m.b64 + 0.5*m.x161 + 0.5*m.x163 - m.x180 + m.x182 <= 13)

m.c294 = Constraint(expr=   13*m.b63 + 13*m.b64 + 0.5*m.x161 + 0.5*m.x163 + m.x180 - m.x182 <= 26)
...
m.c299 = Constraint(expr= - 12*m.b65 - 12*m.b66 + 0.5*m.x151 + 0.5*m.x154 - m.x171 + m.x174 <= 0)

m.c300 = Constraint(expr= - 12*m.b65 + 12*m.b66 + 0.5*m.x151 + 0.5*m.x154 + m.x171 - m.x174 <= 12)

m.c301 = Constraint(expr=   13*m.b65 - 13*m.b66 + 0.5*m.x161 + 0.5*m.x164 - m.x180 + m.x183 <= 13)

m.c302 = Constraint(expr=   13*m.b65 + 13*m.b66 + 0.5*m.x161 + 0.5*m.x164 + m.x180 - m.x183 <= 26)
...
m.c307 = Constraint(expr= - 12*m.b67 - 12*m.b68 + 0.5*m.x152 + 0.5*m.x153 - m.x172 + m.x173 <= 0)

m.c308 = Constraint(expr= - 12*m.b67 + 12*m.b68 + 0.5*m.x152 + 0.5*m.x153 + m.x172 - m.x173 <= 12)

m.c309 = Constraint(expr=   13*m.b67 - 13*m.b68 + 0.5*m.x162 + 0.5*m.x163 - m.x181 + m.x182 <= 13)

m.c310 = Constraint(expr=   13*m.b67 + 13*m.b68 + 0.5*m.x162 + 0.5*m.x163 + m.x181 - m.x182 <= 26)
...
m.c315 = Constraint(expr= - 12*m.b69 - 12*m.b70 + 0.5*m.x152 + 0.5*m.x154 - m.x172 + m.x174 <= 0)

m.c316 = Constraint(expr= - 12*m.b69 + 12*m.b70 + 0.5*m.x152 + 0.5*m.x154 + m.x172 - m.x174 <= 12)

m.c317 = Constraint(expr=   13*m.b69 - 13*m.b70 + 0.5*m.x162 + 0.5*m.x164 - m.x181 + m.x183 <= 13)

m.c318 = Constraint(expr=   13*m.b69 + 13*m.b70 + 0.5*m.x162 + 0.5*m.x164 + m.x181 - m.x183 <= 26)
...
m.c323 = Constraint(expr= - 12*m.b71 - 12*m.b72 + 0.5*m.x153 + 0.5*m.x154 - m.x173 + m.x174 <= 0)

m.c324 = Constraint(expr= - 12*m.b71 + 12*m.b72 + 0.5*m.x153 + 0.5*m.x154 + m.x173 - m.x174 <= 12)

m.c325 = Constraint(expr=   13*m.b71 - 13*m.b72 + 0.5*m.x163 + 0.5*m.x164 - m.x182 + m.x183 <= 13)

m.c326 = Constraint(expr=   13*m.b71 + 13*m.b72 + 0.5*m.x163 + 0.5*m.x164 + m.x182 - m.x183 <= 26)
