...
class TestMindtPy(unittest.TestCase):
    ...
    #         self.assertIn(results.solver.termination_condition,
    #                       [TerminationCondition.optimal, TerminationCondition.feasible])
    #         self.assertAlmostEqual(value(model.objective.expr), 68, places=1)
    ...
    #         self.assertAlmostEqual(value(model.objective.expr), 3.5, places=2)
    ...
    #                       TerminationCondition.optimal)
    #         self.assertAlmostEqual(
    #             value(model.objective.expr), 6.00976, places=2)
    ...
    #         self.assertAlmostEqual(
    #             value(model.objective.expr), -5.512, places=2)
    ...
    #                       [TerminationCondition.optimal, TerminationCondition.feasible])
    #         self.assertAlmostEqual(
    #             value(model.objective.expr), 0.66555, places=2)
    ...
    #                       TerminationCondition.optimal)
    #         self.assertAlmostEqual(
    #             value(model.objective.expr), 3.6572, places=2)
    ...
    # #         self.assertIs(results.solver.termination_condition,
    # #                       TerminationCondition.optimal)
    # #         self.assertAlmostEqual(value(model.objective.expr), 0.66555, places=2)
