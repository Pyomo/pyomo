...
def run_diving_heuristic(m: _BlockData, nlp_solver: appsi.base.Solver):
    prob = DivingHeuristic(m, nlp_solver)
    res = pybnb.solve(prob, queue_strategy=pybnb.QueueStrategy.bound, objective_stop=prob.infeasible_objective())
