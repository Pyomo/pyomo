...
class TestDecomposition(unittest.TestCase):
    ...
    def test_communities_5(self):
        ...
        correct_community_maps = ["{0: (['c1', 'c2', 'c3', 'c4', 'c5'], ['i1', 'i2', 'i3', 'i4', 'i5', 'i6'])}",
...
def _collect_community_maps(model):
    ...
    # Convert list_of_community_maps to a string because memory locations may vary by OS and PC
    list_of_community_maps = [str(community_map) for community_map in list_of_community_maps]
