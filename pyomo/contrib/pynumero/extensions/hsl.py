...
class MA27_LinearSolver(object):
    ...
    libname = find_pynumero_library('pynumero_HSL')
...
#                                                                                 array_1d_int,
#                                                                                 ctypes.c_int]
#         self.HSLib.EXTERNAL_MA57Interface_do_symbolic_factorization.restype = None
#
#         # numeric factorization
...
#         pjcols = jcols.astype(np.intc, casting='safe', copy=False)
#         assert irows.size == jcols.size, "Dimension error. Pointers should have the same size"
#         self.HSLib.EXTERNAL_MA57Interface_do_symbolic_factorization(self._obj,
#                                                                     nrowcols,
#                                                                     pirows,
#                                                                     pjcols,
#                                                                     len(pjcols))
