...
class TestGreyBoxModel(unittest.TestCase):
    ...
    def test_compare_evaluations(self):
        ...
        c2list = [
            'egb.eq_constraints[h1bal_1]',
            'egb.eq_constraints[h1bal_2]',
            'egb.eq_constraints[h1bal_3]',
            'egb.eq_constraints[h1bal_4]',
            'egb.eq_constraints[h1bal_5]',
            'egb.eq_constraints[h2bal_1]',
            'egb.eq_constraints[h2bal_2]',
            'egb.eq_constraints[h2bal_3]',
            'egb.eq_constraints[h2bal_4]',
            'egb.eq_constraints[h2bal_5]',
