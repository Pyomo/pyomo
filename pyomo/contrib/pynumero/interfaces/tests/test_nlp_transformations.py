...
from pyomo.contrib.pynumero.interfaces.nlp_transformations import ADMMNLP2
...
class TestADMMNLP2(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.model = create_basic_dense_qp(G, A, b, c)
        cls.pyomo_nlp = PyomoNLP2(cls.model)
        cls.coupling_vars = [cls.pyomo_nlp.variable_idx(cls.model.x[0]),
                             cls.pyomo_nlp.variable_idx(cls.model.x[2])]
        cls.nlp = ADMMNLP2(cls.pyomo_nlp, cls.coupling_vars, rho=2.0)
