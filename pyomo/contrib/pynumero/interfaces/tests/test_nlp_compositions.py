...
from pyomo.contrib.pynumero.interfaces.nlp import PyomoNLP2, NLPgcd
from pyomo.contrib.pynumero.interfaces.nlp_compositions import TwoStageStochasticNLP
from pyomo.contrib.pynumero.interfaces.nlp_compositions import TwoStageStochasticNLP2
...
@unittest.skipIf(os.name in ['nt', 'dos'], "Do not test on windows")
class TestTwoStageStochasticNLP2(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.nlp = TwoStageStochasticNLP2(cls.scenarios, cls.coupling_vars)
