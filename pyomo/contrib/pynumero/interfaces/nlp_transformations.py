...
class ADMMNLP(NLP):
    ...
    def __init__(self,
        ...
        ----------
        nlp: NLP
        complicated_vars: with complicated variable indices
        rho: penalty parameter

        """

        super(ADMMNLP, self).__init__(None)
...
class ADMMNLP2(NLPgcd):
    ...
    def __init__(self,
        ...
        super(ADMMNLP2, self).__init__(nlp.model)
