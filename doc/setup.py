...
"""
Script to generate the installer for pyomo.doc.
"""
...
setup(name='pyomo.doc',
      version='1.4',
      maintainer='William E. Hart',
      maintainer_email='wehart@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/pyomo/pyomo.doc',
      license = 'BSD',
      platforms = ["any"],
      description = "Pyomo's online books and documentation",
