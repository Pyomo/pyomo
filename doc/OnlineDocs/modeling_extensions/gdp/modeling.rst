...
.. doctest::
    ...
    >>> m.p = LogicalConstraint(expr=m.Y[1].implies(And(m.Y[2], m.Y[3])).or_(m.Y[4]))
    >>> m.p.pprint()
...
+==============+========================+===================================+================================+
| Conjunction  |                        | :code:`Y[1].and_(Y[2])`           | :code:`And(Y[1],Y[2])`         |
+--------------+------------------------+-----------------------------------+--------------------------------+
| Disjunction  |                        | :code:`Y[1].or_(Y[2])`            | :code:`Or(Y[1],Y[2])`          |
+--------------+------------------------+-----------------------------------+--------------------------------+
...
.. code::
    ...
    m.p = LogicalConstraint(expr=Or(m.Y[1], m.Y[2]).implies(
        And(m.Y[3], ~m.Y[4], m.Y[5].or_(m.Y[6])))
    )
