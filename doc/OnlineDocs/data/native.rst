...
In many cases, Pyomo models can be constructed without :class:`Set
<ref pyomo.core.base.sets.Set>` and :class:`Param <ref
pyomo.core.base.param.Param>` data components.  Native Python data
types class can be simply used to define constant values in Pyomo
expressions.  Consequently, Python sets, lists and dictionaries can
