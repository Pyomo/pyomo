...
- Solver Interfaces
  ...
  - Solver Refactor - Allow no objective (#3181)
  ...
  - Solver Refactor - Bug fixes for IDAES Integration (#3214)
  - Check _skip_trivial_constraints before the constraint body (#3226)
  - Fix AMPL solver duplicate funcadd (#3206)
  - Solver Refactor - Fix bugs in setting `name` and `solutions` attributes (#3228)
