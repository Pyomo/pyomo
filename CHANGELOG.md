...
- Contributed Packages
  ...
  - incidence_analysis: Add documentation and update API (#2727)
  ...
  - PyNumero: Extend ExternalPyomoModel to support implicit function solvers (#2652)
  - PyROS: Fix user_time and wallclock_time bug (#2670)
  - PyROS: Add more judicious enforcement of PyROS Solver time limit (#2660)
  - PyROS: Update documentation (#2698)
