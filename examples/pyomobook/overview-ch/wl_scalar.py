...
# @cons:
model.one_warehouse_for_NYC = pyo.Constraint(expr=model.x_Harlingen_NYC + model.x_Memphis_NYC + model.x_Ashland_NYC == 1)

model.one_warehouse_for_LA = pyo.Constraint(expr=model.x_Harlingen_LA + model.x_Memphis_LA + model.x_Ashland_LA == 1)
#...
# @:cons
