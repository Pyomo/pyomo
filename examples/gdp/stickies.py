...
model.screen_flow_existence1 = Constraint(model.ScreenPairs, rule=screen_flow_existence_rule1)

def screen_flow_existence_rule2(model, s, sprime):
    return model.screen_selection_disjunct[1,s].indicator_var >= \
        model.flow_rejection_disjunct[sprime, s, 1].indicator_var
model.screen_flow_existence2 = Constraint(model.ScreenPairs, rule=screen_flow_existence_rule2)
